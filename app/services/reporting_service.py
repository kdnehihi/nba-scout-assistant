...
def build_metadata_response(resources: AppResources) -> dict[str, Any]:
    ...
    metadata["runtime_version"] = resources.runtime_version
    metadata["response_cache"] = resources.response_cache.health()
...
def build_scouting_report_response(
    ...
    return get_or_set_cached_json(
        ...
        key,
        cache_ttl_seconds("SCOUTING_REPORT_CACHE_TTL_SECONDS", 3600),
        build,
    )
