...
from .features_long_term import build_long_term_training
from .features_performance import build_performance_training
from .features_role import build_role_features
from .features_salary import build_salary_training
from .loaders import (
    DataPaths,
...
def build_all_gold_datasets(paths: DataPaths) -> dict[str, object]:
    ...
    salary_training = build_salary_training(salaries, salary_cap, players, role_features)
    ...
    outputs = {
        ...
        "salary_training_clean": salary_training,
